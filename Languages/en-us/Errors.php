...
$txt['cannot_reorder_sticky'] = 'You cannot reorder the sticky posts - there are not enough to reorder.';
...
$txt['invalid_board_slug'] = 'You did not provide a valid board slug for its URL, this can only contain A-Z, a-z, 0-9, _ or -.';
$txt['slug_exists'] = 'You cannot use \'%1$s\' as a board slug, this is already in use on another board.';
...
$txt['error_dob_required'] = 'A valid date of birth is required.';
$txt['error_dob_not_old_enough'] = 'You must be aged at least %1$s to register.';
...
$txt['error_recaptcha_not_complete'] = 'Please complete the "I am not a robot" option.';
