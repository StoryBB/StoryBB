...
$txt['deleteAccount_posts'] = 'Remove replies made by this member to any topic';
$txt['deleteAccount_topics'] = 'Remove entire topics (and all replies) if started by this member';
