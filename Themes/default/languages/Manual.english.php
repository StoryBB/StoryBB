...
$txt['manual_smf_user_help'] = 'StoryBB User Help';
...
$txt['manual_docs_and_credits'] = 'For more information about how to use StoryBB, please see the <a href="%1$s" target="_blank" class="new_win">Simple Machines Documentation Wiki</a> and check out the <a href="%2$s">credits</a> to find out who has made StoryBB what it is today.';
