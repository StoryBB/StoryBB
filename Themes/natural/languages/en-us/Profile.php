...
/**
 * This file contains language strings for the profile pages.
 *
...
$txt['topic_tracker_posted'] = 'Topics posted in';
$txt['topic_tracker_invited'] = 'Topics invited to';
...
$txt['deleteAccount_posts_ooc'] = 'Remove out-of-character replies made by this member to any topic';
$txt['deleteAccount_topics_ooc'] = 'Remove entire out-of-character topics (and all replies) that were started by this member';
$txt['deleteAccount_posts_ic'] = 'Remove in-character replies made by this member to any topic';
$txt['deleteAccount_topics_ic'] = 'Remove entire in-character topics (and all replies) that were started by this member';
...
$txt['notification_info'] = 'StoryBB allows you to be notified of replies to posts, newly posted topics, etc. You can change those settings here, or oversee the topics and boards you are currently receiving notifications for.';
