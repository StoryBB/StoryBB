		...
		return [
			...
			Table::make('ban_items',
				[
					...
					'ip_low' => Column::varbinary(16),
					'ip_high' => Column::varbinary(16),
			...
			Table::make('log_comments',
				[
					...
					'recipient_name' => Column::mediumint(),
					'log_time' => Column::int(),
			...
			Table::make('log_errors',
				[
					...
					'error_type' => Column::varchar(15)->default('default'),
			...
			Table::make('members',
				[
					...
					'avatar' => Column::varchar(255),
					'member_ip' => Column::varbinary(16),
					'member_ip2' => Column::varbinary(16),
					...
					'id_msg_last_visit' => Column::smallint(),
					'additional_groups' => Column::varchar(255),
					'id_post_group' => Column::smallint(),
					'total_time_logged_in' => Column::smallint(),
