...
/**
 * Displays the character posts page.
 *
...
class CharacterPosts extends AbstractProfileController
{
	...
	public function display_action()
	{
		...
		$context['page_index'] = constructPageIndex($scripturl . '?action=profile;area=character_posts;char=' . $context['character']['id_character'] . ';u=' . $context['id_member'] . (!empty($board) ? ';board=' . $board : ''), $context['start'], $msgCount, $maxIndex);
