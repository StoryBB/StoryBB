...
function Display()
{
	...
	$context['num_views_text'] = numeric_context('read_times', $context['topicinfo']['num_views']);
	...
	$context['can_reply_unapproved'] &= (empty($context['topicinfo']['locked']) || allowedTo('moderate_board'));
