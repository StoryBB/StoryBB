 ...
 * @var string
 */
$boardurl = 'http://localhost:80';
/**
 * Email address to send emails from. (like noreply@yourdomain.com.)
 * @var string
 */
$webmaster_email = 'noreply@storyBBtesting.com';
/**
 * Name of the cookie to set for authentication.
 * @var string
 */
$cookiename = 'SMFCookie532';
 ...
 * @var string
 */
$image_proxy_secret = '46bb56afa10ad2b1b91a';
 ...
 * @var string
 */
$boarddir = '/data/StoryBB';
/**
 * Path to the Sources directory.
 * @var string
 */
$sourcedir = '/data/StoryBB/Sources';
/**
 ...
 * @var string
 */
$tasksdir = '/data/StoryBB/Sources/tasks';
