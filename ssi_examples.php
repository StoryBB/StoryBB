...
?>
			...
			<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return sbbSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php require(&quot;<?php echo addslashes($user_info['is_admin'] ? realpath($boarddir . '/SSI.php') : 'SSI.php'); ?>&quot;); ?&gt;</code>
			...
			<div id="sidenav" class="windowbg">
				...
				<div class="content">
					...
					<h3>Advanced Functions <span class="help main_icons" title="Functions that require additional tweaking, not just copy and paste."></span></h3>
					<ul>
...
<!-- RECENT ITEMS -->
			<div class="ssi_preview" id="ssi_recentTopics">
				...
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return sbbSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_recentTopics(); ?&gt;</code>
...
<!-- ADVANCED FUNCTIONS -->
			<div class="ssi_preview" id="ssi_showPoll">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return sbbSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_showPoll($topicID); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_fetchPosts">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return sbbSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_fetchPosts($postIDs, $isOverride); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_fetchMember">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return sbbSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_fetchMember($memberIDs); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="ssi_fetchGroupMembers">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return sbbSelectText(this);" class="codeoperation">[Select]</a></div><code class="bbc_code">&lt;?php ssi_fetchGroupMembers($groupIDs); ?&gt;</code>
				<h3>Result</h3>
			...
			<div class="ssi_preview" id="htmlhome">
				...
				<h3>Code</h3>
				<div class="codeheader">Code: <a href="javascript:void(0);" onclick="return sbbSelectText(this);" class="codeoperation">Select</a></div><code class="bbc_code"><?php echo htmlspecialchars(template_homepage_sample1('source')); ?></code>
				<h3>Result</h3>
...
<html>
	<head>
		...
		<script>
			...
			var sbb_iso_case_folding = ', $context['server']['iso_case_folding'] ? 'true' : 'false', ';
...
<div id="container">
	...
	$footer = '
	<div id="footer">
		<a target="_blank" rel="license noopener" href="https://creativecommons.org/licenses/publicdomain/"><img alt="Creative Commons License" style="border-width:0" src="https://i.creativecommons.org/l/publicdomain/88x31.png"></a>
		This sample website layout is dedicated to the <a target="_blank" rel="license noopener" href="https://creativecommons.org/licenses/publicdomain/">Public Domain</a>.
	</div>
</div>
</body>
</html>';
